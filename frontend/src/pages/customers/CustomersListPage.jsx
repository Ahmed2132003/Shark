  ...
  return (
    <section className="orders-page">
      <header className="orders-page__header">
        <div><h1 className="orders-page__title">{tr('Customers Management', 'إدارة العملاء')}</h1><p className="orders-page__subtitle">Search and review your customer base.</p></div>
        <div style={{ display: 'flex', gap: 12 }}><Link to="/dashboard/orders" className="orders-btn">Orders</Link><Link to="/dashboard" className="orders-btn">{tr('Back to dashboard', 'العودة للداشبورد')}</Link></div>
      </header>
