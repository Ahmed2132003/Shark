...
export default function Dashboard() {
  ...
  return (<section className="admin-dashboard-overview"><header className="admin-dashboard-overview__header"><div><h1>Dashboard Overview</h1><p>Live admin snapshot for sales, orders, customers, and catalog performance.</p></div><div style={{ display: 'flex', gap: 8 }}><Link to="/dashboard/orders" className="admin-dashboard-overview__orders-link">Go to Orders Management</Link><Link to="/dashboard/customers" className="admin-dashboard-overview__orders-link">Go to Customers Management</Link><Link to="/dashboard/invoices" className="admin-dashboard-overview__orders-link">Go to Invoices Management</Link></div></header>    
